...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="fe fe-file"></i>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    dragIcon: '<i class="fe fe-move"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="fe fe-plus-sign text-warning"></i>',
                    indicatorSuccess: '<i class="fe fe-ok-sign text-success"></i>',
                    indicatorError: '<i class="fe fe-exclamation-sign text-danger"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fe fe-triangle-left"></i>',
            next: '<i class="fe fe-triangle-right"></i>',
            toggleheader: '<i class="fe fe-resize-vertical"></i>',
            fullscreen: '<i class="fe fe-fullscreen"></i>',
            borderless: '<i class="fe fe-resize-full"></i>',
            close: '<i class="fe fe-remove"></i>'
        },
        ...
        browseIcon: '<i class="fe fe-folder"></i>&nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="fe fe-trash"></i>',
        removeClass: 'btn btn-danger btn-secondary',
        cancelIcon: '<i class="fe fe-close"></i>',
        ...
        msgValidationErrorIcon: '<i class="fe fe-exclamation-sign"></i> ',
